...
def MarkRouteThroughPointsOnMap( points, folium_map=None, describe=default_describer, color='blue', **kwargs ):
    if not folium_map:
        folium_map = MapForPoints( points )
    ...
    folium.PolyLine(stops, color=color, **kwargs).add_to(folium_map)
    return folium_map
